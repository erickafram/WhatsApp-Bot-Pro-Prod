...
function processMessageWithFlow(message, flowData, currentContext) {
    if (!flowData)
...
*Obrigado pela compreensão!* 🚌✨`;
            ...
            const containsOtherCities = availableCities.some(city => city.toLowerCase() !== 'palmas' && normalizedInput.includes(city.toLowerCase()));
