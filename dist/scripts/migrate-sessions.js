...
async function cleanupExpiredSessions() {
    try {
        ...
        const result = await (0, database_1.executeQuery)(cleanupQuery, []);
        console.log(`✅ ${result?.affectedRows || 0} sessões expiradas removidas`);
    }
    catch (error) {
...
//# sourceMappingURL=migrate-sessions.js.map